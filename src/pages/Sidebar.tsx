...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 fixed top-14 left-0 z-40">
      <aside
        id="logo-sidebar"
        className={`h-screen transition-transform py-4  bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-50 dark:border-gray-100`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-50">
